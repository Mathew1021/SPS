...
//		lobbyServer.sendRoomMessage(userSession, new RoomGameModeChangedHandler(lobbyServer, userSession).getResponse2(), true);
		...
		// Friends chat
			...
			HokeyGoalHandler h = new HokeyGoalHandler(lobbyServer, userSession);
			lobbyServer.sendRoomMessage(userSession, h.getResponse(0), true);
			h.afterSend();
		...
		// Guild chat
			...
			HokeyGoalHandler h = new HokeyGoalHandler(lobbyServer, userSession);
			lobbyServer.sendRoomMessage(userSession, h.getResponse(1), true);
			h.afterSend();
