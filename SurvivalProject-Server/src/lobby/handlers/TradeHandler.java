			...
			for (int i = 0; i < 4; i++) {
				if (trade.firstCards[i] != null && trade.firstCards[i].getCardIndex() != -1) {
					if (trade.firstCards[i].getCardIndex() >= 10000) {
						...
						if (trade.firstCards[i].getCardPremiumDays() > 0) {
							Date date = new Date();
							date.setTime(System.currentTimeMillis() + (long) trade.firstCards[i].getCardPremiumDays() * 24 * 60 * 60 * 1000);
							trade.firstCards[i].setCardPremiumExpirationDate(date);
						}
				...
				if (trade.secondCards[i] != null && trade.secondCards[i].getCardIndex() != -1) {
					if (trade.secondCards[i].getCardIndex() >= 10000) {
						...
						if (trade.secondCards[i].getCardPremiumDays() > 0) {
							Date date = new Date();
							date.setTime(System.currentTimeMillis() + (long) trade.secondCards[i].getCardPremiumDays() * 24 * 60 * 60 * 1000);
							trade.secondCards[i].setCardPremiumExpirationDate(date);
						}
