...
public class Card {
	...
	private Date cardPremiumExpirationDate;
...
//	}
	...
	@Type(type = "timestamp")
	@Column(name = "card_premium_expiration_date")
	public Date getCardPremiumExpirationDate() {
		return cardPremiumExpirationDate;
	}

	public void setCardPremiumExpirationDate(Date cardPremiumExpirationDate) {
		this.cardPremiumExpirationDate = cardPremiumExpirationDate;
	}
}
