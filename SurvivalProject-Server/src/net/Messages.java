...
public class Messages {
	...
	public static final int UNKNOWN_LOBBY_RESPONSE_12 = 0x4346; // like game completed. you only gain elements in quests/missions though
	public static final int UNKNOWN_LOBBY_RESPONSE_13 = 0x4347; // this one changes your items/elements/code it seems TODO maybe level up response according to b6oy. it is also according to ida
	...
	public static final int UNKNOWN_LOBBY_RESPONSE_27 = 0x4377; // this one sets a lot of unknown fields in MyInfo. ServerJoinResponse according to b6oy
	...
	public static final int UNKNOWN_LOBBY_RESPONSE_44 = 0x4407; // RoomChampWnd, ElementWnd
	...
	public static final int HOKEY_GOAL_OLD_VERSION_RESPONSE = 0x4422; // Doesn't support goals tracking and endless game
	public static final int HOKEY_GOAL_RESPONSE = 0x4423;
	...
	public static final int VISIT_BONUS_RESPONSE = 0x4461; // not
	...
	public static final int INFINITY_WIN_STATS_RESPONSE = 0x4473; // championship win packet
	...
	public static final int UNKNOWN_LOBBY_RESPONSE_89 = 0x4488; // Used in all game modes except infinity modes
